...
- When you move an item in your inventory that has a large amount of data, but drag your cursor slightly as you put it down, the server doesn't like that and puts it back in your cursor or drops it. We fix this by modifying the click packet for a one-item stack to .
